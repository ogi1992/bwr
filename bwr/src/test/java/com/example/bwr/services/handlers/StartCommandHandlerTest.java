...
class StartCommandHandlerTest {
  ...
  void handle() {
    ...
    startCommandHandler.handle(taskMessage);
    ...
    assertEquals(ActionType.START_COMMAND_ACK, auditLogMessage.getActionType());
  }
  ...
  @Test
  void getCommand() {
    Command command = startCommandHandler.getCommand();
    assertEquals(Command.START_COMMAND, command);
  }
}